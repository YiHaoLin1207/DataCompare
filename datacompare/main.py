...
from filter import CompareFilter
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.compare_cls_id.setCheckState(self.compare_filter.cls_id)
        self.compare_cls_id.stateChanged.connect(self.compare_filter.set_cls_id)
        ...
        self.compare_s1.setCheckState(self.compare_filter.s1)
        self.compare_s1.stateChanged.connect(self.compare_filter.set_s1)
        ...
        self.compare_std_idno.setCheckState(self.compare_filter.std_idno)
        self.compare_std_idno.stateChanged.connect(self.compare_filter.set_std_idno)
        ...
        self.compare_cls_name_abr.setCheckState(self.compare_filter.cls_name_abr)
        self.compare_cls_name_abr.stateChanged.connect(self.compare_filter.set_cls_name_abr)
        ...
        self.compare_s2.setCheckState(self.compare_filter.s2)
        self.compare_s2.stateChanged.connect(self.compare_filter.set_s2)
        ...
        self.compare_std_key.setCheckState(self.compare_filter.std_key)
        self.compare_std_key.stateChanged.connect(self.compare_filter.set_std_key)
        ...
        self.compare_dgr_id.setCheckState(self.compare_filter.dgr_id)
        self.compare_dgr_id.stateChanged.connect(self.compare_filter.set_dgr_id)
        ...
        self.compare_s3.setCheckState(self.compare_filter.s3)
        self.compare_s3.stateChanged.connect(self.compare_filter.set_s3)
        ...
        self.compare_std_mobile.setCheckState(self.compare_filter.std_mobile)
        self.compare_std_mobile.stateChanged.connect(self.compare_filter.set_std_mobile)
        ...
        self.compare_dvs_id.setCheckState(self.compare_filter.dvs_id)
        self.compare_dvs_id.stateChanged.connect(self.compare_filter.set_dvs_id)
        ...
        self.compare_s4.setCheckState(self.compare_filter.s4)
        self.compare_s4.stateChanged.connect(self.compare_filter.set_s4)
        ...
        self.compare_std_name.setCheckState(self.compare_filter.std_name)
        self.compare_std_name.stateChanged.connect(self.compare_filter.set_std_name)
        ...
        self.compare_kind_id.setCheckState(self.compare_filter.kind_id)
        self.compare_kind_id.stateChanged.connect(self.compare_filter.set_kind_id)
        ...
        self.compare_status1.setCheckState(self.compare_filter.status1)
        self.compare_status1.stateChanged.connect(self.compare_filter.set_status1)
        ...
        self.compare_std_sex.setCheckState(self.compare_filter.std_sex)
        self.compare_std_sex.stateChanged.connect(self.compare_filter.set_std_sex)
        ...
        self.compare_kind_name.setCheckState(self.compare_filter.kind_name)
        self.compare_kind_name.stateChanged.connect(self.compare_filter.set_kind_name)
        ...
        self.compare_status2.setCheckState(self.compare_filter.status2)
        self.compare_status2.stateChanged.connect(self.compare_filter.set_status2)
        ...
        self.compare_std_tel.setCheckState(self.compare_filter.std_tel)
        self.compare_std_tel.stateChanged.connect(self.compare_filter.set_std_tel)
        ...
        self.compare_m1.setCheckState(self.compare_filter.m1)
        self.compare_m1.stateChanged.connect(self.compare_filter.set_m1)
        ...
        self.compare_src_flag.setCheckState(self.compare_filter.src_flag)
        self.compare_src_flag.stateChanged.connect(self.compare_filter.set_src_flag)
        ...
        self.compare_unt_id.setCheckState(self.compare_filter.unt_id)
        self.compare_unt_id.stateChanged.connect(self.compare_filter.set_unt_id)
        ...
        self.compare_m2.setCheckState(self.compare_filter.m2)
        self.compare_m2.stateChanged.connect(self.compare_filter.set_m2)
        ...
        self.compare_src_kind.setCheckState(self.compare_filter.src_kind)
        self.compare_src_kind.stateChanged.connect(self.compare_filter.set_src_kind)
        ...
        self.compare_yms_sms.setCheckState(self.compare_filter.yms_sms)
        self.compare_yms_sms.stateChanged.connect(self.compare_filter.set_yms_sms)
        ...
        self.compare_m3.setCheckState(self.compare_filter.m3)
        self.compare_m3.stateChanged.connect(self.compare_filter.set_m3)
        ...
        self.compare_src_status.setCheckState(self.compare_filter.src_status)
        self.compare_src_status.stateChanged.connect(self.compare_filter.set_src_status)
        ...
        self.compare_pass_yn.setCheckState(self.compare_filter.pass_yn)
        self.compare_pass_yn.stateChanged.connect(self.compare_filter.set_pass_yn)
        ...
        self.compare_std_id.setCheckState(self.compare_filter.std_id)
        self.compare_std_id.stateChanged.connect(self.compare_filter.set_std_id)
